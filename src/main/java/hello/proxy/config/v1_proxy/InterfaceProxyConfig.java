...
import hello.proxy.config.v1_proxy.interface_froxy.OrderControllerInterfaceProxy;
import hello.proxy.config.v1_proxy.interface_froxy.OrderRepositoryInterfaceProxy;
import hello.proxy.config.v1_proxy.interface_froxy.OrderServiceInterfaceProxy;
